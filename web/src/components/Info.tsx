...
const Info = () => {
    return (
        <Card title="">
            ...
            <Textarea readOnly w={"100%"} autosize variant="unstyled">
                The tool takes a Mini-Haskell expression as input and parses it into a Abstract Syntax Tree (AST).
                For this we wrote our own Grammar. Its not clear that this grammar is exactly the grammar which the creators of Mini-Haskell had in mind.
            </Textarea>
            <Textarea readOnly w={"100%"} autosize variant="unstyled">
            ...
            </Textarea><Textarea readOnly w={"100%"} autosize variant="unstyled">
